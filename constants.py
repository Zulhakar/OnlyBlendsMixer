...
SINGLE_VALUES_SOCKET_SHAPE = 'SQUARE'
VERSATILE_SOCKET_SHAPE = 'CIRCLE'
#not used for sound nodes
FIELDS_SOCKET_SHAPE = 'DIAMOND'

SOUND_SOCKET_SHAPE = SINGLE_VALUES_SOCKET_SHAPE
DEVICE_SOCKET_SHAPE = SINGLE_VALUES_SOCKET_SHAPE
...
#rgba(0, 209, 160, 0)
#COLOR_SPEAKER_SOCKET = (0.0, 0.8164, 0.625, 1.0)
COLOR_SPEAKER_SOCKET = COLOR_WHITE
# Node Desciptions
SAMPLE_TO_GEOMETRY_NODE_DESCRIPTION = "Add Geometry from Sound Sample Node"
SAMPLE_TO_MESH_NODE_DESCRIPTION = "Create Mesh from Sound Sample Node"